/* ========================================
   CITAS - DATOS COMPARTIDOS (copia para /user)
   Fuente unica de verdad para leer y escribir
   las citas guardadas en localStorage.

   Es una copia de admin/js/citas-datos.js (mismo
   patron que user/js/tipos-servicio.js): el area
   /user/ no referencia archivos dentro de /admin/,
   asi que este modulo se duplica aqui para que las
   paginas de usuario (user-citas.html) tengan las
   mismas funciones de fecha/estado/lectura de citas.
======================================== */
